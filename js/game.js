...
function createGame(event) {
	...
	var onGameOver = function(fighter) {
		...
		if (fighter.name == "player1") {
			...
			VK.api('wall.post', {message: "Я продержался "+fight+" "+getNumEnding(fight, ['уровень', 'уровня', 'уровней'])+"! Сможешь больше? Тогда заходи: vk.com/app5655136", attachments: 'photo-130115811_434054997'});
